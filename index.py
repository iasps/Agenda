...
class IndexUI:
  ...
  def menu_admin():
    op = st.sidebar.selectbox("Menu", ["Manter Agenda", "Manter Clientes", "Manter Serviços", "Abrir Agenda do Dia", "Reajustar Preço", "Editar perfil", "Solicitações"])
  ...
  def menu_cliente():
    op = st.sidebar.selectbox("Menu", ["Agenda de Hoje", "Agendar Horário", "Meus agendamentos", "Editar perfil"])
